...
library RLPReaderExt {
    ...
    function strictBytes32FromRLP(RLPReader.RLPItem memory item) internal pure returns (bytes32) {
    ...
    function keccak256FromRawRLP(RLPReader.RLPItem memory item) internal pure returns (bytes32 ret) {
        assembly {
