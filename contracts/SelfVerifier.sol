...
contract SelfVerifier is AbstractVerifier {
    constructor(string[] memory urls, uint256 window, IVerifierHooks hooks) AbstractVerifier(urls, window, hooks) {}
    ...
    function getStorageValues(
        ...
        if (blockHash != keccak256(p.rlpEncodedBlock)) revert("Self: blockhash");
    ...
    function verify(
        ...
        return GatewayVM.evalRequest(req, ProofSequence(0, stateRoot, proofs, order, _hooks));
    }
}
