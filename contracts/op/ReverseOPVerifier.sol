...
contract ReverseOPVerifier is AbstractVerifier {
    ...
    function getStorageValues(
        ...
        bytes32 storageRoot = _hooks.verifyAccountState(stateRoot, address(_l1Block), p.accountProof);
        blockHash = _hooks.verifyStorageValue(storageRoot, address(_l1Block), SLOT_HASH, p.storageProof);
